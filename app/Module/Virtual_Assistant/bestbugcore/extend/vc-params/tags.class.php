...
if(!class_exists('Exlac_Extend_VcParams_Tags'))
{
	class Exlac_Extend_VcParams_Tags
	{
		...
		function init()
		{
			if ( class_exists( 'WpbakeryShortcodeParams' ) && is_admin() )
			{
				...
				if(is_admin()) {
					...
					WpbakeryShortcodeParams::addField('bb_tags' , array($this, 'bb_tags'), EXLAC_CORE_URL . '/assets/admin/js/extend/vc-params/tags.js');
				}
			}
		}
		...
		public function adminEnqueueScripts() {
			...
			wp_enqueue_style( 'bb-tags', EXLAC_CORE_URL . '/assets/admin/css/extend/vc-params/tags.css' );
	...
	new Exlac_Extend_VcParams_Tags();
}
