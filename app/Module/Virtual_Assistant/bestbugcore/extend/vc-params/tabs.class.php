...
vc_add_param( $shortcode, array(
	...
	'active' => ExlacVCEDOHelper::$tab_active,
	'tabs' => $tabs,
	'suffix' => array('typo', 'show_hide'),
	'class' => ExlacVCEDOHelper::$menu_tab_position,
	'group' => $group,
)); */

if(!class_exists('Exlac_Extend_VcParams_Tabs'))
{
	class Exlac_Extend_VcParams_Tabs
	{
		...
		function init()
		{
			...
			{
				WpbakeryShortcodeParams::addField('bb_tabs' , array($this, 'bb_tabs'), EXLAC_CORE_URL . '/assets/admin/js/extend/vc-params/tabs.js');
		...
		public function adminEnqueueScripts() {
			wp_enqueue_style( 'bb-tabs', EXLAC_CORE_URL . '/assets/admin/css/extend/vc-params/tabs.css' );
		}

	}

	new Exlac_Extend_VcParams_Tabs();
}
