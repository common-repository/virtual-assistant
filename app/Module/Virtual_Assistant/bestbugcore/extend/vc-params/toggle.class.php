...
if(!class_exists('Exlac_Extend_VcParams_Toggle'))
{
	class Exlac_Extend_VcParams_Toggle
	{
		...
		function init()
		{
			if ( class_exists( 'WpbakeryShortcodeParams' ) && is_admin() )
			{
				// Load enqueueScripts
				if(is_admin()) {
					WpbakeryShortcodeParams::addField('bb_toggle' , array($this, 'bb_toggle'), EXLAC_CORE_URL . '/assets/admin/js/extend/vc-params/toggle.js');
	...
	new Exlac_Extend_VcParams_Toggle();
}
